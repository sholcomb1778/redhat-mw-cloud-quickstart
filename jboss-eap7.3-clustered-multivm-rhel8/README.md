...
3. [Subscriptions and Costs](#licenses-subscriptions-and-costs)
...
This Azure Resource Manager (ARM) template creates all the Azure compute resources to run JBoss EAP 7.3 cluster on top of n number of RHEL 8.0 VMs where n is decided by the user and all the VMs are added to the backend pool of a Load Balancer. The following resources are created by this template:
...
To learn more about the JBoss Enterprise Application Platform, visit [Red Hat EAP 7.3 documentation](https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.3/).
